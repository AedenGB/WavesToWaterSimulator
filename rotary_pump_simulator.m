...
hold off
legend('angular velocity of pump', 'water surface height', 'linear displacement of buoy', 'minimum required rpm for pump');
...
function [time, angular_velocity, linear_displacement] = functions(time_old, angular_velocity_old, linear_displacement_old, C)
    ...
    torque = cap_to_positive(C.pulley_radius*linear_force*1.0) - pump_torque; %only positive torque from mooring line 
