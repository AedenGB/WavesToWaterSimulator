...
C.pulley_radius = 0.08 * (0.0254);%convert inches to meters
...
' m  |  R_{spool} = ', num2str(C.pulley_radius),... 
...
function [time, angular_velocity, linear_displacement] = functions(time_old, angular_velocity_old, linear_displacement_old, C)
    ...
    return_spring_torque = C.return_spring_coefficient*linear_displacement_old/C.pulley_radius;
